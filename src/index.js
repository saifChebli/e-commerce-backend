...
// Ensure settings are loaded so invoices/taxes use current values
try { require('./routes/settings').__loadSettings && require('./routes/settings').__loadSettings(); } catch (_) {}
